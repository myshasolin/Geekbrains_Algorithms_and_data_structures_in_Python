...
# не моё решение, нашёл в интернете, но честно в него вник. Комментарии автора сего чуда
...
def huffman_encode(s):  # функция кодирования строки в коды Хаффмана
    ...
    for ch, freq in Counter(s).items():  # построим очередь с циклом, добавив счетчик, уникальный для всех листьев
